...
<div class="table-responsive">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <li>
                <a href="${pageContext.request.contextPath}/toLessonList?start=${pre}"
                   aria-label="Previous">
            ...
            <c:forEach var="i" begin="1" end="${pageCount}" step="1">
                <li>
                    <a href="${pageContext.request.contextPath}/toLessonList?start=${i}">${i}</a>
                </li>
            </c:forEach>
            <li>
                <a href="${pageContext.request.contextPath}/toLessonList?start=${next}"
                   aria-label="Next">

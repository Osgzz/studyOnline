...
public class EmployeeController {
    ...
    public String toEmployeeList(Model model, @RequestParam(required = false, defaultValue = "") String searchName, @RequestParam(required = false, defaultValue = "1") Integer start) {
        ...
        PageInfo<EmployeeWithDeptNameAndPositon> pageInfo = new PageInfo<>(employeeList);

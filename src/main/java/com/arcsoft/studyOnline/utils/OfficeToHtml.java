...
/**
 * Created by Focus on 2017/7/11.
 */
public class OfficeToHtml {
    private static OfficeToHtml doc2HtmlUtil;
    /**
     * 获取Doc2HtmlUtil实例
     */
    public static synchronized OfficeToHtml getDoc2HtmlUtilInstance() {
        if (doc2HtmlUtil == null) {
            doc2HtmlUtil = new OfficeToHtml();
        }
        return doc2HtmlUtil;
    }
    ...
    public static void main(String[] args) throws IOException {
        OfficeToHtml coc2HtmlUtil = getDoc2HtmlUtilInstance();
        File file = null;
...
//        coc2HtmlUtil.file2pdf(fileInputStream, "D:/poi-test/openOffice/ppt","ppt");
        ...
        file = new File("D:/1.pptx");
        fileInputStream = new FileInputStream(file);
      coc2HtmlUtil.file2Html(fileInputStream, "D:/result","pptx");
//        coc2HtmlUtil.file2pdf(fileInputStream, "D:/result","pptx");
